                ...
                <div class="block-content">
                    <div class="row items-push">
                        <div class="col-md-4 col-lg-5">
                            ...
                            <img class="img-fluid rounded" src="assets/media/photos/photo10.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-md-8 col-lg-7 d-md-flex align-items-center">
                            <div>
                                <h4 class="mb-1">
                                    <a class="text-dark" href="be_pages_blog_story.html">Top 10 destinations to visit in your lifetime</a>
                                </h4>
            ...
            <div class="block block-rounded">
                <div class="block-content">
                    <div class="row items-push">
                        <div class="col-md-4 col-lg-5">
                            <a class="img-link img-link-simple" href="be_pages_blog_story.html">
                                <img class="img-fluid rounded" src="assets/media/photos/photo1.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-md-8 col-lg-7 d-md-flex align-items-center">
                            <div>
                                <h4 class="mb-1">
                                    <a class="text-dark" href="be_pages_blog_story.html">How to start your own digital business</a>
                                </h4>
                                <div class="fs-sm fw-medium mb-3">
                                    <a href="be_pages_generic_profile.html">Amber Harvey</a> on July 13, 2021 · <span class="text-muted">15 min</span>
                                </div>
                                <p class="fs-sm text-muted">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..
                                </p>
            ...
            <div class="block block-rounded">
                <div class="block-content">
                    <div class="row items-push">
                        <div class="col-md-4 col-lg-5">
                            <a class="img-link img-link-simple" href="be_pages_blog_story.html">
                                <img class="img-fluid rounded" src="assets/media/photos/photo4.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-md-8 col-lg-7 d-md-flex align-items-center">
                            <div>
                                <h4 class="mb-1">
                                    <a class="text-dark" href="be_pages_blog_story.html">How to manage working while traveling</a>
                                </h4>
                                <div class="fs-sm fw-medium mb-3">
                                    <a href="be_pages_generic_profile.html">Barbara Scott</a> on July 6, 2021 · <span class="text-muted">12 min</span>
                                </div>
                                <p class="fs-sm text-muted">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..
                                </p>
            ...
            <div class="block block-rounded">
                <div class="block-content">
                    <div class="row items-push">
                        <div class="col-md-4 col-lg-5">
                            <a class="img-link img-link-simple" href="be_pages_blog_story.html">
                                <img class="img-fluid rounded" src="assets/media/photos/photo24.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-md-8 col-lg-7 d-md-flex align-items-center">
                            <div>
                                <h4 class="mb-1">
                                    <a class="text-dark" href="be_pages_blog_story.html">Sleeping better is doable</a>
                                </h4>
                                <div class="fs-sm fw-medium mb-3">
                                    <a href="be_pages_generic_profile.html">Scott Young</a> on July 21, 2021 · <span class="text-muted">9 min</span>
                                </div>
                                <p class="fs-sm text-muted">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..
                                </p>
            ...
            <div class="block block-rounded">
                <div class="block-content">
                    <div class="row items-push">
                        <div class="col-md-4 col-lg-5">
                            <a class="img-link img-link-simple" href="be_pages_blog_story.html">
                                <img class="img-fluid rounded" src="assets/media/photos/photo7.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-md-8 col-lg-7 d-md-flex align-items-center">
                            <div>
                                <h4 class="mb-1">
                                    <a class="text-dark" href="be_pages_blog_story.html">Best 15 sunsets to experience</a>
                                </h4>
                                <div class="fs-sm fw-medium mb-3">
                                    <a href="be_pages_generic_profile.html">Danielle Jones</a> on June 5, 2021 · <span class="text-muted">5 min</span>
                                </div>
                                <p class="fs-sm text-muted">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..
                                </p>
            ...
            <div class="block block-rounded">
                <div class="block-content">
                    <div class="row items-push">
                        <div class="col-md-4 col-lg-5">
                            <a class="img-link img-link-simple" href="be_pages_blog_story.html">
                                <img class="img-fluid rounded" src="assets/media/photos/photo8.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-md-8 col-lg-7 d-md-flex align-items-center">
                            <div>
                                <h4 class="mb-1">
                                    <a class="text-dark" href="be_pages_blog_story.html">Amazing places you should visit</a>
                                </h4>
                                <div class="fs-sm fw-medium mb-3">
                                    <a href="be_pages_generic_profile.html">Betty Kelley</a> on June 1, 2021 · <span class="text-muted">3 min</span>
                                </div>
                                <p class="fs-sm text-muted">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..
                                </p>
            ...
            <div class="bg-body-dark rounded-3 p-4">
                ...
                <a class="block block-rounded mb-3" href="be_pages_generic_profile.html">
                    <div class="block-content block-content-full text-center">
                        ...
                        <div class="fs-5 fw-semibold">Alice Moore</div>
