...
@section('content')
@section('title', 'Add Certificate ISO 9001')
    ...
    <div class="block block-rounded block-themed">
        ...
        <div class="block-content block-content-full">
            <div class="row">
                ...
                <form class="space-y-4" action="{{ url('admin/certificates/9001/create') }}" method="POST">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="date" class="form-control" id="issue_date" name="issue_date" placeholder="d-m-Y" data-date-format="d-m-Y" required>
                        </div>
                    </div>
                    <div class="row">
