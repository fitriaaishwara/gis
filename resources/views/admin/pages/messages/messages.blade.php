                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    <thead>
                        <tr>
                            ...
                            <th class="fs-xs text-center" style="width: 10%">Phone</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell fs-sm d-none d-sm-table-cell fs-sm text-center">{{ $item->name }}</td>
                            <td class="d-none d-sm-table-cell fs-sm text-center">{{ $item->phone }}</td>
                            <td class="d-none d-sm-table-cell fs-sm text-center">{{ $item->email }}</td>
                            <td class="d-none d-sm-table-cell fs-sm text-center">{{ $item->subject }}</td>
                            <td class="d-none d-sm-table-cell fs-sm text-center">{{ $item->message }}</td>
