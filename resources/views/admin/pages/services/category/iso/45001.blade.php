...
@section('content')
@section('title', 'Services - Category - ISO 45001')
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
                <h1 class="h3 fw-bold mb-2">
                    Kategori Ruang Lingkup ISO 45001
                </h1>
...
<div class="content">
    ...
    <a class="btn btn-sm btn-dark mb-4" href="{{ url('/admin/services/schema/iso/45001')}}">
        ...
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <div class="block-content fs-sm">
                    <form action="{{ url('admin/services/category/iso/45001/') }}" method="post" id="form-add-categories" enctype="multipart/form-data" >
                        @csrf
                        <div class="mb-3">
...
<script type="text/javascript">
    ...
    $('#galleryTable').on("click", ".btnDelete", function() {
            ...
            if (result.value) {
                let url = "{{ url('admin/services/category/iso/45001/delete/:id') }}";
...
<script>
    function editDataCategory(id){
        $.ajax({
            url: "{{ url('admin/services/category/iso/45001') }}/"+ id + "/edit",
            type: "GET",
            dataType: "JSON",
            success: function(data){
                $('#modal-edit-category').modal('show');
                $('#modal-edit-category form').attr('action', "{{ url('/admin/services/category/iso/45001/edit/update/') }}/" + id);
