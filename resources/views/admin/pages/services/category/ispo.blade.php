...
@section('content')
@section('title', 'Services - Category - ISPO')
...
<div class="content">
    ...
    <a type="button" class="btn btn-sm btn-dark mb-4" href="{{ url('/admin/services/schema/ispo')}}">
        ...
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <div class="block-content fs-sm">
                    <form action="{{ url('admin/services/category/ispo/') }}" method="post" id="form-add-categories" enctype="multipart/form-data" >
                        @csrf
                        <div class="mb-3">
...
<script type="text/javascript">
    ...
    $('#galleryTable').on("click", ".btnDelete", function() {
            ...
            if (result.value) {
                let url = "{{ url('admin/services/category/ispo/delete/:id') }}";
...
<script>
    function editDataCategory(id){
        $.ajax({
            url: "{{ url('admin/services/category/ispo') }}/"+ id + "/edit",
            type: "GET",
            dataType: "JSON",
            success: function(data){
                $('#modal-edit-category').modal('show');
                $('#modal-edit-category form').attr('action', "{{ url('/admin/services/category/ispo/edit/update/') }}/" + id);
