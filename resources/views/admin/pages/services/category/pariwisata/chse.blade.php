...
@section('content')
@section('title', 'Services - Category - Pariwisata - CHSE')
...
<div class="content">
    ...
    <a class="btn btn-sm btn-dark mb-4" href="{{ url('/admin/services/schema/pariwisata/chse')}}">
        ...
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <div class="block-content fs-sm">
                    <form action="{{ url('admin/services/category/pariwisata/chse/') }}" method="post" id="form-add-categories" enctype="multipart/form-data" >
                        @csrf
                        <div class="mb-3">
...
<script type="text/javascript">
    ...
    $('#galleryTable').on("click", ".btnDelete", function() {
            ...
            if (result.value) {
                let url = "{{ url('admin/services/category/pariwisata/chse/delete/:id') }}";
...
<script>
    function editDataCategory(id){
        $.ajax({
            url: "{{ url('admin/services/category/pariwisata/chse') }}/"+ id + "/edit",
            type: "GET",
            dataType: "JSON",
            success: function(data){
                $('#modal-edit-category').modal('show');
                $('#modal-edit-category form').attr('action', "{{ url('/admin/services/category/pariwisata/chse/edit/update/') }}/" + id);
