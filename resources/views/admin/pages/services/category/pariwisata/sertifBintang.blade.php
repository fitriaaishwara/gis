...
@section('content')
@section('title', 'Services - Category - Pariwisata - Sertifikasi Bintang')
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
                <h1 class="h3 fw-bold mb-2">
                    Kategori Ruang Lingkup Sertifikasi Bintang
                </h1>
...
<div class="content">
    ...
    <a type="button" class="btn btn-sm btn-dark mb-4" href="{{ url('/admin/services/schema/pariwisata/sertifikasi-bintang')}}">
        ...
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <div class="block-content fs-sm">
                    <form action="{{ url('admin/services/category/pariwisata/sertifikasi-bintang/') }}" method="post" id="form-add-categories" enctype="multipart/form-data" >
                        @csrf
                        <div class="mb-3">
...
<script type="text/javascript">
    ...
    $('#galleryTable').on("click", ".btnDelete", function() {
            ...
            if (result.value) {
                let url = "{{ url('admin/services/category/pariwisata/sertifikasi-bintang/delete/:id') }}";
...
<script>
    function editDataCategory(id){
        $.ajax({
            url: "{{ url('admin/services/category/pariwisata/sertifikasi-bintang') }}/"+ id + "/edit",
            type: "GET",
            dataType: "JSON",
            success: function(data){
                $('#modal-edit-category').modal('show');
                $('#modal-edit-category form').attr('action', "{{ url('/admin/services/category/pariwisata/sertifikasi-bintang/edit/update/') }}/" + id);
