...
@section('content')
@section('title', 'Services - Category - Jasa Rehabilitasi')
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
                <h1 class="h3 fw-bold mb-2">
                    Kategori Ruang Lingkup Jasa Rehabilitasi
                </h1>
...
<div class="content">
    ...
    <a type="button" class="btn btn-sm btn-dark mb-4" href="{{ url('/admin/services/schema/sni/jasa/jasa-rehabilitasi')}}">
        ...
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <div class="block-content fs-sm">
                    <form action="{{ url('admin/services/category/sni/jasa-rehabilitasi/') }}" method="post" id="form-add-categories" enctype="multipart/form-data" >
                        @csrf
                        <div class="mb-3">
...
<script type="text/javascript">
    ...
    $('#galleryTable').on("click", ".btnDelete", function() {
            ...
            if (result.value) {
                let url = "{{ url('admin/services/category/sni/jasa-rehabilitasi/delete/:id') }}";
...
<script>
    function editDataCategory(id){
        $.ajax({
            url: "{{ url('admin/services/category/sni/jasa-rehabilitasi') }}/"+ id + "/edit",
            type: "GET",
            dataType: "JSON",
            success: function(data){
                $('#modal-edit-category').modal('show');
                $('#modal-edit-category form').attr('action', "{{ url('/admin/services/category/sni/jasa-rehabilitasi/edit/update/') }}/" + id);
