...
@section('content')
@section('title', 'Ruang Lingkup Sertifikasi Bintang')
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
                <h1 class="h3 fw-bold mb-2">
                    Ruang Lingkup Sertifikasi Bintang
                </h1>
...
<div class="content">
    ...
    <a class="btn btn-sm btn-dark mb-4" href="{{ url('/admin/services/category/pariwisata/sertifikasi-bintang')}}">
        ...
        <div class="block-content block-content-full">
            <div class="table-responsive">
                <table id="galleryTable"  class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                    ...
                    <tbody>
                        @foreach ($sertifikasiBintang as $index => $item)
                        <tr>
        ...
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <div class="block-content fs-sm">
                    <form action="{{ url('admin/services/schema/pariwisata/sertifikasi-bintang') }}" method="post" id="form-add-categories" enctype="multipart/form-data" >
                        @csrf
                        <div class="mb-3">
...
<script type="text/javascript">
    ...
    $('#galleryTable').on("click", ".btnDelete", function() {
            ...
            if (result.value) {
                let url = "{{ url('admin/services/schema/pariwisata/chse/delete/:id') }}";
