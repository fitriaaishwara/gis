...
@section('content')
@section('title', 'Ruang Lingkup Pasar Rakyat')
...
<div class="content">
    ...
    <a class="btn btn-sm btn-dark mb-4" href="{{ url('/admin/services/category/sni/pasar-rakyat')}}">
        ...
        <div class="block-content block-content-full">
            <div class="table-responsive">
                <table id="galleryTable"  class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                    ...
                    <tbody>
                        @foreach ($pasarRakyat as $index => $item)
                        <tr>
                            ...
                            <td class="fw-semibold fs-sm">{{ $item->category_id }}</td>
        ...
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                ...
                <div class="block-content fs-sm">
                    <form action="{{ url('admin/services/schema/sni/jasa/pasar-rakyat') }}" method="post" id="form-add-categories" enctype="multipart/form-data" >
                        @csrf
                        <div class="mb-3">
...
<script type="text/javascript">
    ...
    $('#galleryTable').on("click", ".btnDelete", function() {
            ...
            if (result.value) {
                let url = "{{ url('admin/services/schema/sni/jasa/pasar-rakyat/delete/:id') }}";
...
<script>
    function editDataCategory(id){
        $.ajax({
            url: "{{ url('admin/services/schema/sni/jasa/pasar-rakyat') }}/"+ id + "/edit",
            type: "GET",
            dataType: "JSON",
            success: function(data){
                $('#modal-edit-category').modal('show');
                $('#modal-edit-category form').attr('action', "{{ url('/admin/services/schema/sni/jasa/pasar-rakyat/edit/update/') }}/" + id);
