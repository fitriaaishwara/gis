...
@section('content')
@section('title', 'Verification Certificate - ISO 45001')
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-12 col-xl-4 col-lg-6 breadcrumb justify-content-center justify-content-lg-end text-small alt-font md-margin-10px-top">
                ...
                <ul class="xs-text-center">
                    ...
                    <li>Sistem Manajemen Mutu (ISO 45001)</li>
                </ul>
                <!-- end breadcrumb -->
            </div>
        </div>
...
<section class="container py-5-5 my-5-5">
    <h4 class="alt-font font-weight-600 text-slate-blue letter-spacing-minus-1px margin-15px-bottom text-center">Verification Certificate ISO 45001</h4>
    <p class="w-75 mx-auto lg-w-95 sm-w-100 text-center">Sertifikasi Sistem Manajemen Kesehatan dan Keselamatan Kerja (SMK3) iso 45001</p>
    <br>
    <table class="w-100 table table-sm table-hover justify-content-center mb-5">
        <thead>
            <tr>
