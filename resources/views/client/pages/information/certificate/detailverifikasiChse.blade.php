...
@section('content')
@section('title', 'Verification Certificate - CHSE')
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-12 col-xl-4 col-lg-6 breadcrumb justify-content-center justify-content-lg-end text-small alt-font md-margin-10px-top">
                ...
                <ul class="xs-text-center">
                    ...
                    <li>CHSE (Cleanliness, Health, Safety, and Environment Sustainablility)</li>
                </ul>
                <!-- end breadcrumb -->
            </div>
        </div>
...
<section class="container py-5-5 my-5-5">
    ...
    <p class="w-75 mx-auto lg-w-95 sm-w-100 text-center">Lembaga Sertifikasi Usaha Pariwisata (CHSE)</p>
    <br>
