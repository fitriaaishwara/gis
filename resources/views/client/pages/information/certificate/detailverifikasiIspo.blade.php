...
@section('content')
@section('title', 'Verification Certificate - LSPRO')
...
<section class="container py-5-5 my-5-5">
    ...
    <p class="w-75 mx-auto lg-w-95 sm-w-100 text-center">Indonesian Sustainable Palm Oil (ISPO)</p>
    <br>
    <table class="w-100 table table-sm table-hover justify-content-center">
        <thead>
            ...
            <tr>
                ...
                <td>
                    {{ $verifikasi->titik_koordinat_lokasi }}
                </td>
            </tr>
            <tr>
                <td class="font-weight-600">
            ...
            <tr>
                ...
                <td>
                    {{ $verifikasi->model_rantai_pemasok }}
                </td>
            </tr>
            <tr>
                <td class="font-weight-600">
            ...
            <tr>
                ...
                <td>
                    {{ date('d F Y', strtotime($verifikasi->third_surveillance)) }}
                </td>
            </tr>
            <tr>
                <td class="font-weight-600">
                ...
                <td>
                    {{ date('d F Y', strtotime($verifikasi->fourth_surveillance)) }}
                </td>
            </tr>
            <tr>
                <td class="font-weight-600">
                ...
                <td>
                    {{ date('d F Y', strtotime($verifikasi->reSertifikasi)) }}
                </td>
            </tr>
            <tr>
                <td class="font-weight-600">
