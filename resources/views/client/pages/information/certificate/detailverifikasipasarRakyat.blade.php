...
@section('content')
@section('title', 'Verification Certificate - Pasar Rakyat')
...
<section class="container py-5-5 my-5-5">
    ...
    <p class="w-75 mx-auto lg-w-95 sm-w-100 text-center">Pasar Rakyat Certification</p>
    <br>
    <table class="w-100 table table-sm table-hover justify-content-center">
        <thead>
            ...
            <tr>
                <td class="font-weight-600">
                    Tanggal Terbit Sertifikat / Periode
                </td>
                <td style="width: 10px" class="text-center">
                    :
                </td>
                <td>
                    {{ date('d F Y', strtotime($verifikasi->certificate_date_period)) }}
                </td>
            </tr>
            <tr>
                <td class="font-weight-600">
