...
@section('content')
@section('title', 'Keluhan dan Banding')
    ...
    <div class="container">
        <div class="row align-items-stretch justify-content-center small-screen">
            <div class="col-12 col-xl-12 col-lg-7 col-md-8 position-relative page-title-extra-small text-center d-flex justify-content-center flex-column">
                ...
                <h2 class="text-white alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom" style="font-size: 250%;">Keluhan dan Banding</h2>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 position-relative">
                <span class="alt-font margin-20px-bottom text-gradient-sky-blue-pink d-inline-block text-uppercase font-weight-500 letter-spacing-1px">LS & LS ISPO</span>
                <h5 class="alt-font font-weight-600 text-extra-dark-gray">Keluhan dan Banding</h5>
                <p class="w-80 margin-4-half-rem-bottom md-w-100">Dibawah ini merupakan skema keluhan dan banding untuk Lembaga Sertifikasi (LS) & Lembaga Sertifikasi Indonesia Sustainable Palm Oil System Certification (ISPO):</p>
            </div>
            <div class="row">
                <div class="col-12 col-lg-10 tab-style-05">
                    <div class="tab-box">
                        <!-- start tab navigation -->
                        <ul class="nav nav-tabs margin-7-rem-bottom md-margin-5-rem-bottom xs-margin-15px-lr align-items-center font-weight-500 text-uppercase">
                            <li class="nav-item alt-font"><a class="nav-link active" href="#tab-nine1" data-bs-toggle="tab">Keluhan dan Banding LS</a></li>
                            <li class="nav-item alt-font"><a class="nav-link" href="#tab-nine2" data-bs-toggle="tab">Keluhan dan Banding LS ISPO</a></li>
                        </ul>
                        <!-- end tab navigation -->
                    </div>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane med-text fade in active show" id="tab-nine1">
                            <div class="panel-group accordion-event accordion-style-04" id="accordion1" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                                <div class="col-12 col-lg-12 col-md-8 shopping-content padding-55px-right md-padding-15px-right sm-margin-30px-bottom">
                                    <img src="{{ asset('assets/client/images/GIS/process/new/flowchart-keluhan-banding-ls.png')}}" alt="flowchart-keluhan-banding-ls" width="1500px">
                                </div>
                            </div>
                        </div>
                        <!-- end tab content -->
                        ...
                        <div class="tab-pane fade in" id="tab-nine2">
                            <div class="panel-group accordion-event accordion-style-04" id="accordion2" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                                <div class="col-12 col-lg-12 col-md-8 shopping-content padding-55px-right md-padding-15px-right sm-margin-30px-bottom">
                                    <img src="{{ asset('assets/client/images/GIS/process/new/flowchart-keluhan-banding-lsispo.png')}}" alt="flowchart-keluhan-banding-ls" width="1500px">
                                </div>
                            </div>
                        </div>
                        <!-- end tab content -->
