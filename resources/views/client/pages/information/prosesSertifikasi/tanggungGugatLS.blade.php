...
@section('content')
@section('title', 'Tanggung Gugat LS')
    ...
    <div class="container">
        <div class="row align-items-stretch justify-content-center small-screen">
            <div class="col-12 col-xl-12 col-lg-7 col-md-8 position-relative page-title-extra-small text-center d-flex justify-content-center flex-column">
                ...
                <h2 class="text-white alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom" style="font-size: 250%;">Tanggung Gugat LS</h2>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 position-relative">
                <span class="alt-font margin-20px-bottom text-gradient-sky-blue-pink d-inline-block text-uppercase font-weight-500 letter-spacing-1px">FLOWCHART</span>
                <h5 class="alt-font font-weight-600 text-extra-dark-gray">Prosedur Tanggung Gugat</h5>
                <p class="w-80 margin-4-half-rem-bottom md-w-100">Dibawah prosedur proses tanggung gugat :</p>
            </div>
            <div class="col-12 col-lg-12 col-md-8 shopping-content padding-55px-right md-padding-15px-right sm-margin-30px-bottom">
                <img src="{{ asset ('assets/client/images/GIS/process/new/tanggung_gugat.jpg')}}" alt="" class="img-fluid w-100">
            </div>
        </div>
    </div>
</section>
