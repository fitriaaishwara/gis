...
<!-- start page title -->
<section class="parallax bg-extra-dark-gray" data-parallax-background-ratio="0.5" style="background-image:url('{{ asset ('assets/client/images/GIS/37001.jpg')}}');">
    ...
    <div class="container">
        <div class="row align-items-stretch justify-content-center small-screen">
            <div class="col-12 col-xl-12 col-lg-7 col-md-8 position-relative page-title-extra-small text-center d-flex justify-content-center flex-column">
                <h1 class="alt-font text-white opacity-6 margin-20px-bottom" style="font-size: 150%">ISO 37001</h1>
                <h2 class="text-white alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom" style="font-size: 200%;">Lembaga Sertifikasi Sistem Manajemen Anti Penyuapan</h2>
            </div>
            <div class="down-section text-center"><a href="#9" class="section-link"><i class="ti-arrow-down icon-extra-small text-white bg-transparent-black padding-15px-all xs-padding-10px-all border-radius-100"></i></a></div>
        </div>
    </div>
</section>
<!-- end page title -->
<section id="9" class="bg-light-gray wow animate__fadeIn">
    <div class="container">
        <div class="row align-items-center">
            {{-- <div class="col-12 col-xl-4  col-lg-5 order-lg-2 md-margin-50px-bottom sm-margin-30px-bottom wow animate__fadeInRight" data-wow-delay="0.4s" data-wow-duration="0.6s">
                <div class="outside-box-right">
                    <img src="{{ asset('assets/client/images/GIS/landing/header/bg_iso_9001.jpg') }}" class="box-shadow-medium border-radius-5px overflow-hidden" alt="" />
                </div>
            </div> --}}
            <div class="col-12 col-xl-12 col-lg-12 order-lg-1 padding-five-right sm-padding-15px-right wow animate__fadeIn" data-wow-delay="0.2s">
                <h5 class="alt-font cd-headline slide font-weight-500 text-extra-dark-gray line-height-40px margin-40px-bottom">
                    ...
                    <span class="cd-words-wrapper d-initial p-0">
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px is-visible">ISO 37001</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">ISO 37001</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">ISO 37001</b>
                    </span>
                </h5>
                <p style="text-align: justify;">Terbitnya Peraturan Mahkamah Agung (Perma) No. 13 Tahun 2016 tentang Tata Cara Penanganan
                    Perkara Tindak Pidana oleh Korporasi yang diikuti dengan tingginya keterlibatan pelaku usaha dalam
                    kasus tindak pidana korupsi merupakan landasan utama yang mendorong Pemerintah untuk
                    mengajak seluruh instansi dan perusahaan korporasi untuk menerapkan system manajemen ISO
                    37001. Berdasarkan Pasal 4 ayat (2) poin c Perma No. 13 Tahun 2016, bahwa salah satu bentuk
                    kesalahan korporasi yang terkait dengan pertanggungjawaban pidana adalah jika korporasi tidak
                    melakukan upaya pencegahan, mencegah dampak yang lebih besar, dan memastikan kepatuhan
                    terhadap ketentuan hukum yang berlaku guna menghindari terjadinya tindak pidana.</p>
                {{-- <ul class="list-style-01 text-extra-dark-gray">
                    <li style="text-align: justify;"><i class="fas fa-check text-extra-medium-gray"></i>Tujuan dan manfaat penerapan ISO 9001:2015 untuk mengatur sistem administrasi dan dokumen perusahaan atau organisasi.<span class="list-hover bg-white box-shadow-small border-radius-4px"></span></li>
                    <li style="text-align: justify;"><i class="fas fa-check text-extra-medium-gray"></i>Tujuan dan manfaat penerapan ISO 9001:2015 untuk mengelola resiko yang dapat muncul dalam sebuah perusahaan maupun organisasi yang menjadi tujuan penerapan ISO 9001:2015 yang baru.<span class="list-hover bg-white box-shadow-small border-radius-4px"></span></li>
                    <li style="text-align: justify;"><i class="fas fa-check text-extra-medium-gray"></i>Tujuan dan manfaat penerapan ISO 9001:2015 untuk membangun sistem dasar dalam perusahaan atau organisasi terpenuhi dari mulai aturan yang berhubungan dengan manusia (HR) sampai dengan hal yang mengatur tentang proses (produksi).<span class="list-hover bg-white box-shadow-small border-radius-4px"></span></li>
                    <li style="text-align: justify;"><i class="fas fa-check text-extra-medium-gray"></i>Tujuan dan manfaat penerapan ISO 9001:2015 untuk memastikan setiap proses dan tahapan telah dilakukan sesuai aturan prosedur maupun standard baku yang telah diterapkan.<span class="list-hover bg-white box-shadow-small border-radius-4px"></span></li>
                    <li style="text-align: justify;"><i class="fas fa-check text-extra-medium-gray"></i>Tujuan dan manfaat penerapan ISO 9001:2015 untuk melakukan kontrol terhadap top manajemen agar lebih fokus dan konsisten dalam mencapai sasaran mutu perusahaan yang telah diterapkan.<span class="list-hover bg-white box-shadow-small border-radius-4px"></span></li>
                </ul> --}}
                <p style="text-align: justify;">Perlu digaris bawahi bahwa penerapan panduan ini dalam korporasi bukanlah suatu jaminan
                    hilangnya pertanggungjawaban pidana kepada korporasi apabila tindak pidana korupsi masih terjadi.
                    Namun demikian sistem manajemen SNI ISO 37001 merupakan panduan pencegahan korupsi dan
                    dapat menjadi pertimbangan korporasi</p>
                <p style="text-align: justify;">Di Indonesia, korupsi dipahami secara terbatas sebagai bentuk tindak pidana yang berhubungan
                    dengan keuangan Negara di sektor publik (pemerintahan) dan melibatkan pejabat publik. Namun
                    demikian, praktik korupsi dapat ditemukan di manapun, baik dalam sektor publik, swasta, dan
                    pelakunya pun mulai dari staf hingga direksi, pimpinan atau bahkan pemilik korporasi. Selain itu,
                    modusnya pun bervariasi dari yang sederhana hingga kompleks seperti menyembunyikan hasil
                    kejahatan di berbagai negara. Sebagaimana rencana perubahan Undang-Undang Tindak Pidana
                    Korupsi terkait adopsi UNCAC bahwa pada masa mendatang fraud yang terjadi di kalangan swasta
                    akan termasuk dalam definisi korupsi. Untuk mengurangi potensi terjadinya praktik korupsi pada
                    korporasi, maka diperlukan upaya pencegahan yang memadai, salah satunya dengan penerapan
                    Sistem Manajemen SNI ISO 37001</p>
            </div>
        </div>
    </div>
</section>
...
<section id="portfolio" class="wow animate__fadeIn">
    <div class="container">
        <div class="row justify-content-center mb-2">
            <div class="col-12 col-xl-12 col-lg-6 col-sm-8 text-center margin-5-rem-bottom wow animate__fadeIn">
                <h5 class="alt-font text-extra-dark-gray font-weight-600 w-95 lg-w-100 text-gradient-sky-blue-pink">Ruang Lingkup<br>Sistem Manajemen ISO 37001</h5>
            </div>
        </div>
        {{-- <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-12 text-center text-md-end">
                    ...
                    <ul class="portfolio-filter grid-filter nav nav-tabs justify-content-center alt-font">
                        <li class="nav active"><a data-filter="*" href="#">All</a></li>
                        @foreach ($category9001 as $value)
                            <li class="nav"><a data-filter=".{{ $value->id }}" href="#">{{ $value->category_name }}</a></li>
                        @endforeach
                    </ul>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-9">
                <div class="filter-content w-100 lg-margin-4-rem-top margin-8-half-rem-bottom lg-margin-6-rem-bottom sm-margin-3-rem-tb">
                    <ul class="portfolio-classic portfolio-wrapper grid grid-loading grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large text-center">
                        ...
                        <li class="grid-item {{ $item->category_id }} wow animate__fadeIn">
                            <div class="portfolio-box border-radius-6px box-shadow-large">
                                <div class="portfolio-caption bg-white padding-30px-tb lg-padding-20px-tb">
                                    <a><span class="alt-font text-extra-dark-gray font-weight-500">{{ $item->lingkup}}</span></a>
                    ...
                    <div class="row wow animate__fadeIn" data-wow-delay="0.8s">
                        <div class="col-12 margin-6-rem-top" style="text-align: right;">
                            <a href="{{ url('/contact-us')}}" class="btn btn-fancy btn-medium btn-custom btn-round-edge btn-box-shadow">Kelengkapan Pengajuan</a>
                        </div>
                    </div>
                    <!-- start section -->
                </div>
...
<div id='whatsapp-chat' class='hide'>
    ...
    <div class='start-chat hide'>
        ...
        <div class='blanter-msg'>
            ...
            <a href="//api.whatsapp.com/send?phone=+6281386647726&text=Halo Global Inspeksi Sertifikasi, Saya ingin bertanya tentang sertifikasi ISO 37001" id='send-it'><i class='fab fa-whatsapp'></i>&nbsp Start Chat</a>
        </div>
    </div>
    <div id='get-number'>
    </div>
