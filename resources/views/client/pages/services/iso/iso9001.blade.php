    ...
    <div class="container">
        <div class="row align-items-stretch justify-content-center small-screen">
            <div class="col-12 col-xl-12 col-lg-7 col-md-8 position-relative page-title-extra-small text-center d-flex justify-content-center flex-column">
                <h1 class="alt-font text-white opacity-6 margin-20px-bottom" style="font-size: 150%">ISO 9001</h1>
                <h2 class="text-white alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom" style="font-size: 200%;">Lembaga Sertifikasi Sistem Manajemen Mutu</h2>
            </div>
...
<section id="9" class="bg-light-gray wow animate__fadeIn">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-xl-8 col-lg-6 order-lg-1 padding-five-right sm-padding-15px-right wow animate__fadeIn" data-wow-delay="0.2s">
                <h5 class="alt-font cd-headline slide font-weight-500 text-extra-dark-gray line-height-40px margin-40px-bottom">
                    ...
                    <span class="cd-words-wrapper d-initial p-0">
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px is-visible">ISO 9001</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">ISO 9001</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">ISO 9001</b>
                    </span>
                </h5>
                <p style="text-align: justify;">SNI ISO 9001:2015 merupakan standar internasional di bidang sistem manajemen mutu. Suatu lembaga/organisasi yang telah mendapatkan sertifikasi dalam penerapan SNI ISO 9001:2015, dapat dikatakan telah memenuhi persyaratan internasional dalam hal manajemen penjaminan mutu produk/jasa yang dihasilkannya. Berikut manfaat dan kelebihan penerapan ISO 9001:2015 bagi perusahaan maupun organisasi:</p>
                ...
                <p style="text-align: justify;">Kelima manfaat dan kelebihan penerapan sistem manajemen mutu ISO 9001:2015 tersebut adalah manfaat ISO 9001:2015 yang bisa diambil apabila sebuah perusahaan akan menerapkan sistem manajemen mutu ISO 9001:2015.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center mb-2">
            <div class="col-12 col-xl-12 col-lg-6 col-sm-8 text-center margin-5-rem-bottom wow animate__fadeIn">
                <h5 class="alt-font text-extra-dark-gray font-weight-600 w-95 lg-w-100 text-gradient-sky-blue-pink">Ruang Lingkup<br>Sistem Manajemen ISO 9001</h5>
            </div>
        </div>
        <div class="container">
            <div class="row align-items-center">
...
<div id='whatsapp-chat' class='hide'>
    ...
    <div class='start-chat hide'>
        ...
        <div class='blanter-msg'>
            ...
            <a href="//api.whatsapp.com/send?phone=+6281386647726&text=Halo Global Inspeksi Sertifikasi, Saya ingin bertanya tentang sertifikasi ISO 9001" id='send-it'><i class='fab fa-whatsapp'></i>&nbsp Start Chat</a>
        </div>
    </div>
    <div id='get-number'>
    </div>
