...
<!-- start page title -->
<section class="parallax bg-extra-dark-gray" data-parallax-background-ratio="0.5" style="background-image:url('{{ asset ('assets/client/images/GIS/lsup_neww.jpeg')}}');">
    ...
    <div class="container">
        <div class="row align-items-stretch justify-content-center small-screen">
            <div class="col-12 col-xl-6 col-lg-7 col-md-8 position-relative page-title-extra-small text-center d-flex justify-content-center flex-column">
                <h1 class="alt-font text-white opacity-6 margin-20px-bottom" style="font-size: 150%">LSUP</h1>
                <h2 class="text-white alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom" style="font-size: 250%">Lembaga Sertifikasi Usaha Pariwisata</h2>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-12 col-xl-4  col-lg-5 order-lg-2 md-margin-50px-bottom sm-margin-30px-bottom wow animate__fadeInRight" data-wow-delay="0.4s" data-wow-duration="0.6s">
                <div class="outside-box-right">
                    <img src="{{ asset ('assets/client/images/GIS/lsup_new.jpeg')}}" class="box-shadow-medium border-radius-5px overflow-hidden" alt="" />
                </div>
            </div>
            <div class="col-12 col-xl-7 col-lg-6 order-lg-1 padding-five-right sm-padding-15px-right wow animate__fadeIn" data-wow-delay="0.2s">
                <h5 class="alt-font cd-headline slide font-weight-500 text-extra-dark-gray line-height-40px margin-40px-bottom">
                    ...
                    <span class="cd-words-wrapper d-initial p-0">
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px is-visible">LSUP</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">LSUP</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">LSUP</b>
                    </span>
                </h5>
                <p style="text-align: justify;">Lembaga sertifikasi usaha pariwisata (LSUP) PT. Global Inspeksi Sertifikasi menyediakan jasa sertifikasi usaha pariwisata yang independent dalam memberikan pengakuan terhadap sistem manajemen pada usaha pariwisata sesuai dengan standard yang telah ditentukan.
                    Lembaga sertifikasi usaha pariwisata (LSUP) PT. Global Inspeksi Sertifkasi telah mendapatkan akreditasi dari Komite Akreditasi Nasional (KAN) serta penunjukan dari Kementerian Pariwisata.
                    Beberapa regulasi terkait :</p>
                <ul class="list-style-01 text-extra-dark-gray">
                    <li style="text-align: justify;"><i class="fas fa-check text-extra-medium-gray"></i>Peraturan Menteri Pariwisata dan Ekonomi Kreatif/Kepala Badan Pariwisata dan Ekonomi Kreatif No 18 Tahun 2021 tentang Penyelenggaraan Sertifikasi Usaha Pariwisata.<span class="list-hover bg-white box-shadow-small border-radius-4px"></span></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-2">
            <div class="col-12 col-xl-12 col-lg-6 col-sm-8 text-center margin-5-rem-bottom wow animate__fadeIn">
                <h5 class="alt-font text-extra-dark-gray font-weight-600 w-95 lg-w-100 text-gradient-sky-blue-pink">Ruang Lingkup<br>Lembaga Sertifikasi Usaha Pariwisata</h5>
            </div>
        </div>
        <div class="container">
            <div class="row align-items-center">
                        ...
                        <li class="grid-item {{ $item->category_id }} wow animate__fadeIn">
                            <div class="portfolio-box border-radius-6px box-shadow-large">
                                <div class="portfolio-caption bg-white padding-30px-tb lg-padding-20px-tb">
                                    ...
                                    <span class="text-medium d-block margin-one-bottom" style="font-size:9pt;">({{ $item->deskripsi }})</span>
                                </div>
                            </div>
                        </li>
                        @endforeach
