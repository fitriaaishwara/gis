...
<!-- start page title -->
<section class="parallax bg-extra-dark-gray" data-parallax-background-ratio="0.5" style="background-image:url('{{ asset ('assets/client/images/GIS/ispo_neww.jpeg')}}');">
    ...
    <div class="container">
        <div class="row align-items-stretch justify-content-center small-screen">
            <div class="col-12 col-xl-12 col-lg-7 col-md-8 position-relative page-title-extra-small text-center d-flex justify-content-center flex-column">
                <h1 class="alt-font text-white opacity-6 margin-20px-bottom" style="font-size: 150%">ISPO</h1>
                <h2 class="text-white alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom" style="font-size: 200%;">Indonesia Sustainable Palm Oil System Certification</h2>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-12 col-xl-4  col-lg-5 order-lg-2 md-margin-50px-bottom sm-margin-30px-bottom wow animate__fadeInRight" data-wow-delay="0.4s" data-wow-duration="0.6s">
                <div class="outside-box-right">
                    <img src="{{ asset ('assets/client/images/GIS/ispo_new.jpeg')}}" class="box-shadow-medium border-radius-5px overflow-hidden" alt="" />
                </div>
            </div>
            <div class="col-12 col-xl-7 col-lg-6 order-lg-1 padding-five-right sm-padding-15px-right wow animate__fadeIn" data-wow-delay="0.2s">
                <h5 class="alt-font cd-headline slide font-weight-500 text-extra-dark-gray line-height-40px margin-40px-bottom">
                    ...
                    <span class="cd-words-wrapper d-initial p-0">
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px is-visible">ISPO</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">ISPO</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">ISPO</b>
                    </span>
                </h5>
                <p style="text-align: justify;">Indonesia Sustainable Palm Oil System (ISPO) adalah suatu kebijakan yang diambil oleh Pemerintah Indonesia dalam hal ini Kemetrian Pertanian dengan tujuan untuk meningkatkan daya saing minyak sawit Indonesia di pasar dunia dan ikut berpartisipasi dalam rangka memenuhi komitmen Presiden Republik Indonesia untuk mengurangi gas rumah kaca serta memberi perhatian terhadap masalah lingkungan.
                    <span class="font-weight-600">Peraturan Menteri Pertanian Nomor 38 Thn 2020</span> tentang Sistem Sertifikasi Kelapa Sawit Berkelanjutan Indonesia (ISPO – Indonesia Sustainable Palm Oil).
                    PT Global Inspeksi Sertifikasi telah memperoleh akreditasi dari Komite Akreditasi Nasional (KAN) sebagai salah satu Lembaga Sertifikasi ISPO dengan <span class="font-weight-600">Nomor : LSISPO-005-IDN</span>
...
<section id="portfolio" class="wow animate__fadeIn">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-xl-12 col-lg-6 col-sm-8 text-center wow animate__fadeIn">
                <h5 class="alt-font text-extra-dark-gray font-weight-600 w-95 lg-w-100 text-gradient-sky-blue-pink">Ruang Lingkup<br>Lembaga Sertifikasi ISPO</h5>
            </div>
        </div>
    </div>
...
<div id='whatsapp-chat' class='hide'>
    ...
    <div class='start-chat hide'>
        ...
        <div class='blanter-msg'>
            ...
            <a href="//api.whatsapp.com/send?phone=+6281386647726&text=Halo Global Inspeksi Sertifikasi, Saya ingin bertanya tentang sertifikasi ISPO" id='send-it'><i class='fab fa-whatsapp'></i>&nbsp Start Chat</a>
        </div>
    </div>
    <div id='get-number'>
    </div>
