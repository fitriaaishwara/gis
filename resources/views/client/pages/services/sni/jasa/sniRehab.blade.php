...
<!-- start page title -->
<section class="parallax bg-extra-dark-gray" data-parallax-background-ratio="0.5" style="background-image:url('{{ asset ('assets/client/images/GIS/new/bg_rehab.png')}}');">
    ...
    <div class="container">
        <div class="row align-items-stretch justify-content-center small-screen">
            <div class="col-12 col-xl-6 col-lg-7 col-md-8 position-relative page-title-extra-small text-center d-flex justify-content-center flex-column">
                ...
                <h2 class="text-white alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom" style="font-size: 200%">Layanan Rehabilitasi</h2>
            </div>
            ...
            <div class="col-12 col-xl-12 col-lg-6 order-lg-1 padding-five-right sm-padding-15px-right wow animate__fadeIn" data-wow-delay="0.2s">
                <h5 class="alt-font cd-headline slide font-weight-500 text-extra-dark-gray line-height-40px margin-40px-bottom">
                    ...
                    <span class="cd-words-wrapper d-initial p-0">
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px is-visible">Layanan Rehabilitasi</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">Layanan Rehabilitasi</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">(SNI 8807:2022)</b>
                    </span>
                </h5>
                <p style="text-align: justify;">Standar ini mengatur dan menetapkan persyaratan umum dan persyaratan khusus penyelenggaraan layanan rehabilitasi bagi orang dengan gangguan penggunaan NAPZA. Rehabilitasi yang dimaksud meliputi rehabilitasi medis dan rehabilitasi sosial dalam bentuk layanan rawat jalan dan/atau rawat inap. Standar ini tidak mengatur penyelenggaraan layanan rehabilitasi bagi anak dengan gangguan penggunaan NAPZA.
                </p>
                <p style="text-align: justify;">
                    Persyaratan acuan Sertifikasi Penyelenggara Layanan Rehabilitasi Bagi Orang Dengan Gangguan Penggunaan NAPZA mencakup:
                </p>
                <ul class="list-style-01 text-extra-dark-gray">
                    <li style="text-align: justify;"><i class="fas fa-check text-extra-medium-gray"></i>SNI 8807:2022, Penyelenggara Layanan Rehabilitasi Bagi Pecandu, Penyalahguna, dan Korban Penyalahgunaan Narkotika, Psikotropika dan Zat Adiktif Lainnya (NAPZA);<span class="list-hover bg-white box-shadow-small border-radius-4px"></span>
                    </li>
                    <li style="text-align: justify;"><i class="fas fa-check text-extra-medium-gray"></i>Peraturan terkait yang relevan dengan persyaratan penyelenggara layanan rehabilitasi bagi orang dengan gangguan penggunaan NAPZA<span class="list-hover bg-white box-shadow-small border-radius-4px"></span>
                    </li>
                </ul>
                <br>
            </div>
