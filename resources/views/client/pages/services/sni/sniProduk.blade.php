...
<!-- start page title -->
<section class="parallax bg-extra-dark-gray" data-parallax-background-ratio="0.5" style="background-image:url('{{ asset ('assets/client/images/GIS/sni/bg_sni.jpg')}}');">
    ...
    <div class="container">
        <div class="row align-items-stretch justify-content-center small-screen">
            <div class="col-12 col-xl-6 col-lg-7 col-md-8 position-relative page-title-extra-small text-center d-flex justify-content-center flex-column">
                ...
                <h2 class="text-white alt-font font-weight-500 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom" style="font-size: 250%">Lembaga Sertifikasi Produk LSPRO</h2>
            </div>
...
<!-- end page title -->
<!-- start section -->
<section id="sni" class="bg-light-gray wow animate__fadeIn">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-xl-4  col-lg-5 order-lg-2 md-margin-50px-bottom sm-margin-30px-bottom wow animate__fadeInRight" data-wow-delay="0.4s" data-wow-duration="0.6s">
                <div class="outside-box-right">
                    <img src="{{ asset('assets/client/images/GIS/sni/bg_sni.jpg') }}" class="box-shadow-medium border-radius-5px overflow-hidden" alt="" />
                </div>
            </div>
            <div class="col-12 col-xl-7 col-lg-6 order-lg-1 padding-five-right sm-padding-15px-right wow animate__fadeIn" data-wow-delay="0.2s">
                <h5 class="alt-font cd-headline slide font-weight-500 text-extra-dark-gray line-height-40px margin-40px-bottom">
                    ...
                    <span class="cd-words-wrapper d-initial p-0">
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px is-visible">SNI Produk</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">SNI Produk</b>
                        <b class="text-gradient-light-purple-light-orange border-width-2px border-bottom border-gradient-light-purple-light-orange letter-spacing-minus-1px">SNI Produk</b>
                    </span>
                </h5>
                <p style="text-align: justify;">SNI (Standard Nasional Indonesia) adalah Standar yang berlaku di Indonesia yang merupakan salah satu penentu kualitas teknis atau jasa yang ditawarkan perusahaan. Standar di Indonesia ini adalah Standar Nasional Indonesia (SNI) yang berlaku secara nasional di Indonesia.
                    Sertifikasi produk menjadi penting bagi masyrakat Indonesia karena ini adalah suatu pemastian berupa jaminan tertulis dari pihak ketiga yang independen bahwa suatu produk telah memenuhi persyaratan keamanan,kesehatan, serta keselamatan
                    LSPro PT/ Global Inspeksi Sertifikasi telah memperoleh akreditasi dari KAN untuk 24 ruang lingkup pada November 2017 dan telah memperoleh reakreditasi pada tahun 2021. Beberapa regulasi terkait :</p>
                <ul class="list-style-01 text-extra-dark-gray">
                    <li style="text-align: justify;"><i class="fas fa-check text-extra-medium-gray"></i>UU nomor 20 Tahun 2014 Tentang Standarisasi dan Penilaian Kesesuaian.<span class="list-hover bg-white box-shadow-small border-radius-4px"></span></li>
                    <li style="text-align: justify;"><i class="fas fa-check text-extra-medium-gray"></i>Peraturan menteri perdagangan RI No 72/M-DAG/PER/9/2015 Tentang standarisasi jasa bidang perdagangan dan pengawsan SNI wajib terhadap barang dan jasa yg diperdagangkan.<span class="list-hover bg-white box-shadow-small border-radius-4px"></span></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-2">
            <div class="col-12 col-xl-12 col-lg-6 col-sm-8 text-center margin-5-rem-bottom wow animate__fadeIn">
                <h5 class="alt-font text-extra-dark-gray font-weight-600 w-95 lg-w-100 text-gradient-sky-blue-pink">Ruang Lingkup<br>Lembaga Sertifikasi Produk</h5>
            </div>
        </div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-12 text-center text-md-end">
                    ...
                    <ul class="portfolio-filter grid-filter nav nav-tabs justify-content-center alt-font">
                        ...
                        <li class="nav active"><a data-filter="*" href="#">All</a></li>
                        @foreach ($categoryLspro as $value)
